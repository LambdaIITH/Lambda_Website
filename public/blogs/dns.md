...
**Your computer:** _frantically running around asking 15 different servers where Google lives_

_"How does my computer find google.com?"
"That's the neat part - DNS does it for you!"_
...
4. Your computer: "Thanks!" _(connects to Google)_
5. You: _(sees cat videos)_
...
Imagine I invite you over and say: _"I live in Sweet Home Apartments!"_

**You:** "Cool! How do I get there?"
**Me:** _gives vague directions_
**You:** _gets lost for 2 hours_

Now imagine I say: _"I live at 12-0-29/B, Paradise Street, Silicon Valley, 500032"_

**You:** _punches it into Google Maps_
**You:** _arrives in 15 minutes_
...
_"Billions of internet users"
"One DNS server"
Corporate needs you to find the differences_
...
_"The DNS server is down"
"This is fine"_
Narrator: _It was not fine. The entire internet was down._
...
_Small brain: One DNS server
Medium brain: Multiple DNS servers
Large brain: Hierarchical DNS system
Galaxy brain: 13 root servers controlling billions of requests using anycast_
...
_"I looked up a domain"
"That's the fastest lookup in the West"_
...
_Drake rejecting: Memorizing IP addresses
Drake approving: DNS Records doing it for me_
...
_"How many IPv6 addresses are there?"
"Yes."_
...
_3am:_ Vercel migrates your server to new hardware (new IP: 76.76.21.98)

<!--![Disaster girl meme](https://i.imgflip.com/6/1e348v.jpg)-->

_Your website is down
You're getting angry calls
You can't sleep anymore_
...
_3am:_ Vercel migrates servers, updates THEIR A record

**You:** _sleeping peacefully_ 😴

**Your CNAME:** _still works perfectly_

<!--![Modern problems meme](https://i.imgflip.com/6/2scqyu.jpg)-->

_"Modern problems require modern solutions"
"CNAME records"_
...
_TXT records be like:
"v=spf1 ip4:192.0.2.0/24 include:\_spf.example.com ~all"
"What does it mean?"
"No one knows, but it's provocative"_
...
_"You get your own DNS server!
And YOU get your own DNS server!
EVERYBODY gets their own DNS server!"_
...
_typing "nslookup google.com" in terminal_
"I'm in."
...
_"Edit /etc/hosts to test locally"
"No need to wait for DNS propagation"
"It's free real estate"_
...
_"DNS not working?"
"Have you tried flushing the cache?"_
...
_"DNS propagation takes 24-48 hours"
"Why can't it be instant?"
"Because the internet is held together by duct tape and prayers"_
...
_"DNS pro tips"
"Take my wisdom, young padawan"_
...
_"DNS doing all this work invisibly"
