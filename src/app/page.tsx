      ...
      >
        ...
        <section className="relative isolate min-h-[90vh] flex items-center justify-center pt-20 hero-glow bg-background-dark">
          <div className="absolute inset-0 overflow-hidden -z-10">
            ...
            ></div>
            <div
              className={`absolute bottom-1/4 right-1/4 w-96 h-96 bg-primary/10 rounded-full blur-[120px] ${introFinished ? "animate-blob-fade-in animate-morph-blob" : "opacity-0"}`}
              style={{
                animationDelay: "0.4s",
                opacity: 0,
                animationFillMode: "forwards",
          ...
          <div className="max-w-5xl px-2 text-center z-10">
            <div
              className={`inline-flex items-center gap-2 px-3 py-1 rounded-full border border-primary/30 bg-primary/10 text-primary text-xs font-bold mb-8 uppercase tracking-widest ${introFinished ? "animate-blur-fade-in" : "opacity-0"}`}
              style={{
                animationDelay: "0.1s",
                opacity: 0,
                animationFillMode: "forwards",
            ...
            >
              <span className="relative flex h-2 w-2">
                <span
                  className={`${introFinished ? "animate-ping" : "opacity-0"} absolute inline-flex h-full w-full rounded-full bg-primary opacity-75`}
                ></span>
            ...
            <p
              className={`text-lg md:text-2xl text-slate-500 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed ${introFinished ? "animate-blur-fade-in" : "opacity-0"}`}
              style={{
                animationDelay: "0.7s",
                opacity: 0,
                animationFillMode: "forwards",
            ...
            >
              Engineering excellence through collaboration. We build impactful
              products, contribute to open source, and push the boundaries of
              technology at IIT Hyderabad.
            </p>
          </div>
          {/* bottom transition overlay */}
          <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-40 bg-linear-to-b from-transparent to-[#0d0d0d]" />
        </section>
        {/* About Section */}
              ...
              <ScrollAnimatedSection>
                <div className="animate-blur-fade-in">
                  ...
                  <p className="text-slate-400 text-base md:text-lg mb-8 leading-relaxed">
                    Lambda isn't just a club; it's an incubator for world-class
                    developers. We focus on real-world engineering challenges,
                    from distributed systems to cutting-edge web technologies.
                  </p>
                  <div className="space-y-6">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-slate-500 text-sm">
                          Rust, Go, React, and beyond. We stay ahead of the
                          curve.
                        </p>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-slate-500 text-sm">
                          Peer reviews, pair programming, and intense hack
                          sessions.
                        </p>
                      </div>
                    </div>
                ...
                <div className="relative">
                  ...
                  <div className="w-full lg:w-[125%] bg-[#1e1e1e] rounded-xl border border-primary/20 overflow-hidden flex flex-col relative z-10 shadow-[20px_20px_80px_rgba(148,51,236,0.35)] hover:shadow-[25px_25px_100px_rgba(148,51,236,0.5)] transition-all duration-500 card-3d">
                    <div className="h-8 md:h-10 bg-[#2d2d2d] flex items-center px-3 md:px-4 gap-2 border-b border-white/5">
                      ...
                      <div className="ml-2 md:ml-4 text-[10px] md:text-xs text-white/40 font-mono">
                        lambda-mission.js
                      </div>
                    </div>
                    <div className="p-3 md:p-6 font-mono text-[10px] md:text-sm leading-relaxed overflow-hidden ">
                      <div className="flex gap-2 md:gap-4 code-line-1">
                        ...
                        <span className="text-blue-400 animate-shimmer">
                          Lambda
                        </span>{" "}
                        = {"{"}
                      </div>
                      <div className="flex gap-2 md:gap-4 code-line-2">
                        ...
                        <span className="ml-2 md:ml-4 text-white">
                          mission:
                        </span>{" "}
                        <span className="text-green-400 animate-shimmer">
                          "Innovate"
                        </span>
                        ,
                      </div>
                      ...
                      <div className="flex gap-2 md:gap-4 code-line-7">
                        ...
                        <span className="ml-2 md:ml-4 text-purple-400">
                          if
                        </span>{" "}
                        (curious) {"{"}
                      </div>
                      <div className="flex gap-2 md:gap-4 code-line-8">
                        ...
                        <span className="ml-4 md:ml-8 text-primary animate-shimmer">
                          return
                        </span>{" "}
        ...
        <section className="py-24 px-6 bg-background-dark">
          <div className="max-w-7xl mx-auto text-center">
            <ScrollAnimatedSection>
              <h2 className="text-4xl font-bold mb-4 animate-blur-fade-in">
                Featured Projects
              </h2>
              <p
                className="text-slate-500 mb-16 animate-blur-fade-in"
                style={{
                  animationDelay: "0.1s",
                  animationFillMode: "forwards",
                }}
              >
                High-impact engineering from the student community.
              </p>
            </ScrollAnimatedSection>
              ...
              {topProjects.map((project, index) => (
                <ScrollAnimatedSection key={project.slug}>
                  <div className={`project-card-${index + 1}`}>
                    <ProjectCard
                      category={
                        ["storage", "web", "security"][index] || "storage"
                      }
                      title={project.name}
                      desc={project.desc}
            ...
            <ScrollAnimatedSection>
              <Link
                href="/projects"
                className="inline-block px-8 py-3 border border-primary/50 text-primary rounded-lg font-bold hover:bg-primary/10 hover:shadow-[0_0_20px_rgba(148,51,236,0.4)] transition-all cursor-pointer transform hover:scale-105 magnetic-hover"
              >
                View More Projects
              </Link>
            </ScrollAnimatedSection>
              ...
              <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4 animate-blur-fade-in">
                <div className="text-left">
                  ...
                  <p className="text-slate-500">
                    Insights, tutorials, and deep-dives from our members.
                  </p>
                </div>
                <Link
                  href="/blog"
                  className="px-8 py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg font-bold text-sm transition-all cursor-pointer transform hover:scale-105 hover:border-primary/30"
                >
                  View More Blogs
                </Link>
              </div>
                ...
                {topBlogs.map((blog, index) => (
                  <ScrollAnimatedSection key={blog.id}>
                    <div className={`blog-card-${index + 1}`}>
                      <BlogCard
                        category={
                          ["Article", "Engineering", "Security"][index] ||
                          "Article"
                        }
                ...
                <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
                  <div className="animate-blur-fade-in">
                    ...
                    <p className="text-slate-400 text-lg mb-10 leading-relaxed">
                      Are you a student looking to build? Or a partner
                      interested in hosting a workshop? We're always open to new
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div
                      className="p-6 bg-white/5 rounded-2xl border border-white/5 magnetic-hover animate-slide-up"
                      style={{
                        animationDelay: "0.1s",
                        animationFillMode: "forwards",
                      }}
                    >
                      ...
                      <p className="text-slate-500 text-xs">
                        Industry collaborations and sponsored hackathons.
                      </p>
                    </div>
                    <div
                      className="p-6 bg-white/5 rounded-2xl border border-white/5 magnetic-hover animate-slide-up"
                    ...
                    >
                      ...
                      <p className="text-slate-500 text-xs">
                        Technical sessions led by community experts.
                      </p>
                    </div>
                    <div
                      className="p-6 bg-white/5 rounded-2xl border border-white/5 magnetic-hover animate-slide-up"
                    ...
                    >
                      ...
                      <p className="text-slate-500 text-xs">
                        Maintenance and feature builds for open source.
                      </p>
                    </div>
                    <div
                      className="p-6 bg-white/5 rounded-2xl border border-white/5 magnetic-hover animate-slide-up"
                    ...
                    >
                      ...
                      <p className="text-slate-500 text-xs">
                        Connecting developers across IIT Hyderabad.
                      </p>
                    </div>
                  </div>
                </div>
