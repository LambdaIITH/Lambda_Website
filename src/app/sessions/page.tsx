...
export default function SessionsPage() {
  ...
  useEffect(() => {
    setCurrentPage(1);
    setExpandedCards(new Set()); // Collapse all cards when page/sort changes
  }, [sortLatestFirst]);
  ...
  return (
    <main
      className="w-screen bg-linear-to-b from-[#050505] via-[#0b0212] to-[#050505] text-white flex flex-col items-center pt-20 pb-4"
    >
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-[90vw] md:w-[80vw] mb-24">
        {paginatedPosts.map((post, idx) => {
          const cardId = (currentPage - 1) * POSTS_PER_PAGE + idx;
          ...
          return (
            ...
            >
              ...
              <div className="p-10 flex flex-col flex-1">
                ...
                <p
                  className={`text-slate-400 text-sm leading-relaxed mb-4 font-light transition-all ${
                ...
                {post.description.length > 140 && (
                  <button
                    ...
                    className="self-start mt-auto text-sm font-semibold text-[#9433EC] hover:text-[#b76cff] transition-colors"
                  >
