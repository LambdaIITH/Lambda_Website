        ...
        <div className="space-y-8 text-gray-200">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 pl-4">
              ...
              <li>
                <strong>Application</strong> refers to IITH Dashboard, the
                software program provided by the Company.
              </li>
              <li>
                <strong>Company</strong> (referred to as either "the Company",
                "We", "Us" or "Our" in this Agreement) refers to Lambda, IIT
                Hyderabad.
              </li>
              <li>
          ...
          <section>
            ...
            <h4 className="text-lg font-semibold mb-2">Location Data</h4>
            <p className="mb-3">
              While using certain features of Our Service, such as the campus
              map, We may collect and process your device's location data. This
              location data is used solely to render your live location on the
              campus map feature.
            </p>
            <p>
              We do not share your location data with any third party, and it is
              not sent to any of Our servers. All processing of location data is
              performed locally on your device. Your location information is
              used in real time for display purposes only and is not stored or
              retained once you close the feature.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 pl-4">
              <li>By email: lambda@iith.ac.in</li>
              <li>By visiting this page on our website: https://iith.dev</li>
            </ul>
          </section>
        </div>
      </div>
