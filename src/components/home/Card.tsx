...
export default function Card({ icon: Icon, title, description }: CardProps) {
  return (
    <div className="w-[50vw] md:w-[17vw] md:h-auto bg-[#28013C] text-white md:rounded-[1vw] p-[2vw] flex flex-col items-center text-center border-[#6226A2] hover:bg-[#24003A] border">
