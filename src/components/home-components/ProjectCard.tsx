export default function ProjectCard({category,title,desc,tags}:{category?: String,title: String,desc: String,tags?: String[]}) {
    return (
        <div className="project-card group p-1 bg-gradient-to-br from-white/10 to-transparent rounded-2xl transition-all duration-300 cursor-pointer transform hover:scale-105 hover:shadow-[0_8px_30px_rgba(148,51,236,0.3)]">
            <div className="bg-[#111] p-8 rounded-2xl h-full border border-white/5 flex flex-col items-start text-left group-hover:border-primary/30 transition-all">
                ...
                <p className="text-slate-500 text-sm mb-6 flex-grow">{desc}</p>
