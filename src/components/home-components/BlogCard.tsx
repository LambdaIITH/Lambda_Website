...
export default function BlogCard({category, readDuration,title,desc}: {category?: String, readDuration?: String, title: String, desc: String}) {
    return (
        <Link href="#" className="group block cursor-pointer transform hover:scale-105 transition-all duration-300">
