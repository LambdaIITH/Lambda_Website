...
export default function BackToTop() {
  ...
  return (
    <button
      onClick={scrollToTop}
      className={`fixed bottom-[13vh] right-[3vw] bg-[#1E0A2E] border-2 border-white/20 text-white px-[4vw] py-[2vh] sm:px-[3vw] md:px-[2vw] lg:px-[1.5vw] rounded-lg hover:bg-[#2D0F47] hover:border-white/40 transition-all flex items-center gap-[2vw] md:gap-[1vw] lg:gap-[0.5vw] text-[3.5vw] sm:text-[2.5vw] md:text-[1.5vw] lg:text-[0.9vw] font-medium cursor-pointer z-50 shadow-lg ${
        showBackToTop
